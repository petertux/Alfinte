...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Mostrar Cotizaciones Aprobadas</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Muestra el listado de las cotizaciones aprobadas
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
										<!-- id cotizacion, nombre cliente, fecha_creacion  Total-->
                                            <th>Cotizacion</th>
											<th>Nombre</th>
                                    ...
                                    <tbody>
									<?php
									$rcitas=$cit->ver_cotizaciones_aprobadas();
									foreach($rcitas as $ci){
									$i = $ci['id_cotizacion'];
									echo "
										<tr>
											<td><div id='id_cotizacion$i'>{$ci['id_cotizacion']}</div></td>
											<td>{$ci['nombre']}</td>
											<td>{$ci['fecha_creacion']}</td>
											<td>{$ci['total']}</td>
											<td><a href='recibo.php?id_cotizacion=$i'>Crear Cotizacion</a></td>
										</tr>";	
									}
									?>
                                    </tbody>
