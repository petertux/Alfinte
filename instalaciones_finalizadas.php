...
// Actaulizacion de estado y id_empleado de la Instalaciones

	if(isset($_POST['boton'])){	
    $id_instalacion=$_POST['id_instalacion'];
	$resp_update= $instalaciones->actualizar_instalacionF($id_instalacion);
	}
...
<html lang="en">
  ...
  <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Instalaciones Finalizadas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
<!-- /.row ------------------------------------------------------ -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Muestra el listado de Asignaciones Finalizadas
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                        $rcitas = $instalaciones->mostrar_instalacionesFin();
