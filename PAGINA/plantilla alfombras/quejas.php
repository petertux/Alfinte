   ...
   // require('libreria/motor.php');
    ...
    if(isset($_POST['boton'])){
        if($_POST['nombre'] == ''){
			...
			$subject = $_POST["nombre"]." ".$_POST['apellido']." Comparte Su Queja/Sugerencia";
            $message = $_POST["mensaje"];
			
			mail($mail,$subject,$message,$from);            
            mail($_POST['email'],"Gracias por compartir sus Sugerencias/Quejas","Para Nosotros es muy importante sus opiniones",$from);
           /**********************************************************************/
           ...
           // }else{
                $result = '<div class="result_fail">Mensaje Enviado Satisfactoriamente </div>';
            }
        }
 //   }
?>
    ...
    <header>
                	...
                	<nav>
                      <ul class="menu">
                        ...
                        <li><a href="../index.html">Inicio</a></li>
							...
							<li><a class="active" href="quejas.php">Quejas/Sugerencias</a></li>
                      </ul>
                  </nav>
                </div>
            </div>
        ...
        <div class="row-bot">
        	<div class="row-bot-bg">
            	<div class="main">
                	<h2>Quejas o Sugerencias. <span>Compartanos sus Experiencias</span></h2>
                </div>
            </div>
        </div>
    </header>
    ...
    <section id="content"><div class="ic"></div>
        <div class="main">
            <div class="wrapper">
                ...
                <article class="col-2">
                	<h3 class="p1">Comparta sus Opiniones </h3>
