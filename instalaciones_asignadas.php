...
// Acyaulizacion de estado y id_empleado de la Instalaciones

	if(isset($_POST['boton'])){	
	$cod_emp=$_POST['opcion_emp'];
    $id_instalacion=$_POST['id_instalacion'];
	$resp_update= $instalaciones->actualizar_instalacion($cod_emp,$id_instalacion);		
	}
...
<html lang="en">
  ...
  <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Instalaciones Asignadas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
<!-- /.row ------------------------------------------------------ -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Muestra el listado de los Tecnicos con No. de Asignaciones
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $remp = $instalaciones->mostrar_InstalacionesAsi();
                                        foreach ($remp as $re) {
                                            echo "
										<tr>
											<td>{$re['id_empleado']}</td>
											<td>{$re['nombre']}</td>
											<td>{$re['instalacion']}</td>
                                            <td>"
                                            ?>
                                                <!-- /.panel-heading -->
                                        <form role="form" action="instalaciones_finalizadas.php" method="POST">                                                
						                         <input type="hidden" name="id_instalacion"  value="<?php echo $re['id_instalacion']; ?>" />                                                 
                                                 <button type="submit" class="btn btn-primary" name="boton">Finalizar Instalacion</button>
                                        </form>
