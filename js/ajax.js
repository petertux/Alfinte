...
xmlhttp.open("POST","cotizacion_articulo_media.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str);
}
...
//cargar el estado del articulo
function loadest(str)
{
var xmlhttp;
...
xmlhttp.open("POST","ver_estado.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str);
}
...
xmlhttp.open("POST","asignar_cita.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("q="+str);
}
//asignar empleado
function loademp(str, citaid){
	var xmlhttp;
	...
	xmlhttp.send("q="+str+"&citaid="+citaid);
	
//xmlhttp.send("cita="+val);
}
