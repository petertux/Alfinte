...
<html lang="en">
    ...
    <head>
        ...
        <title>Modulo Instalaciones</title>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
										$rcate=$instalaciones->cantidad_instalaciones();
											foreach($rcate as $ci){
											$numero=$ci['numeroInstalaciones'];
											};
				                        ?>
                        ...
                        <a href="<?php echo $url1; ?>">
                            <div class="panel-footer">
                                <span class="pull-left">Ver Instalaciones</span>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
										$rasig=$instalaciones->cantidad_asi();
											foreach($rasig as $ci){
											$numero=$ci['numeroAsi'];											
											};
									?>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
										$rasig=$instalaciones->cantidad_fin();
											foreach($rasig as $ci){
											$numero=$ci['numeroFin'];											
											};
									?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Muestra el listado de Instalaciones Pendientes, Asignadas y Finalizadas
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>Id Instalaciones</th>
                                            <th>Estado</th>
                                            <th>fecha Creacion</th>
                                            <th>Asignar / Re-Asignar</th>
                                            <th>Asignar</th>                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $rcitas = $instalaciones->mostrar_instalaciones();
                                        foreach ($rcitas as $ci) 
									{
										...
										$disabled="disabled='true'";
                                            ...
                                            echo "
										<tr>
											<td>{$ci['id_instalacion']}</td>
											<td>{$estado}</td>
											<td>{$ci['fecha_creacion']}</td>
											<td>"
                                            ?>

                                        <form role="form" action="instalaciones_asignadas.php" method="POST">                                                
												<p><select <?php echo $disabled; ?> class="form-control" name="opcion_emp">
                                                                            <?php
                                                                            $reemp = $instalaciones->mostrarTec();
                                                 ...
                                                 <td><button <?php echo $disabled; ?> type="submit" class="btn btn-primary" name="boton">Asignar</button></p></td>
						                  <input type="hidden" name="id_instalacion"  value="<?php echo $ci['id_instalacion']; ?>" />
                                          </form>
                                                <!-- Modal -->
